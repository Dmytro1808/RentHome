...
const PropertyDetails = () => {
  ...
  const SignUpSubmit = (e) => {
    ...
    const existingData =
      JSON.parse(localStorage.getItem(house.agent.name)) || [];
    ...
    localStorage.setItem(house.agent.name, JSON.stringify(updatedData));
      ...
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          >
            ...
            <form className="flex flex-col gap-y-4 " onSubmit={SignUpSubmit}>
              <input
              ...
              <div className="flex gap-x-2 ">
                <button
                  type="submit"
                  className="bg-violet-700 rounded text-sm transition w-full p-4 hover:bg-violet-800 text-white "
                >
                  Send message
                </button>
                <a
                  href={`tel:${house.agent.phone}`}
                  className="border text-center border-violet-700 hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition"
                >
                  Call
                </a>
              </div>
