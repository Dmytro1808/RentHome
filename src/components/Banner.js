  ...
  return (
    <section className="h-full max-h-[640px] mb-8 xl:mb-24">
      <div className="flex flex-col lg:flex-row">
        <div
          className="lg:px-0 lg:ml-8 lg:text-left xl:ml-[135px] flex flex-col 
        items-center lg:items-start text-center 
        justify-center flex-1 px-4"
        >
          <h1
          ...
          <p className="max-w-[480px] mb-8">
            No more trouble finding a place. We’ll help you find your dream
            house.
          </p>
        </div>
